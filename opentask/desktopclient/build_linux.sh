...
mkdir -p "${DIST}/opt/opentask/opentask/webclient"
mkdir -p "${DIST}/opt/opentask/opentask/desktopclient"
cp -r app/                       "${DIST}/opt/opentask/app"
cp -r opentask/webclient/        "${DIST}/opt/opentask/opentask/webclient"
cp -r opentask/desktopclient/    "${DIST}/opt/opentask/opentask/desktopclient"
...
#!/bin/bash
cd /opt/opentask
exec .venv/bin/python opentask/desktopclient/main.py "$@"
LAUNCHER
